...
if (isset($_SESSION['data_siswa']) && !empty($_SESSION['data_siswa'])) {
    $buttonPrint = '<a href="print.php" style="margin-left: 5px;" class="icon-print"><i class="fa-solid fa-print fa-lg"></i>Print</a>';
    $buttonHapus = '<a href="hapusAll.php" style="margin-left: 5px;" class="icon-minus"><i class="fa-solid fa-trash fa-lg"></i>Delete</a>';
}
                    ...
                    <?php if (isset($_SESSION['data_siswa']) && is_array($_SESSION['data_siswa'])) : ?>
                        <?php foreach($_SESSION["data_siswa"] as $key => $data) : ?>
                            <tr>
                                ...
                                <td class="aksi">
                                    <a href="hapus.php?id=<?= $key; ?>" ><i class="fa-solid fa-user-minus"></i></a>
                                    <a href="detail.php?id=<?= $key; ?>" ><i class="fa-solid fa-magnifying-glass"></i></a>
                                    <a href="edit.php?id=<?= $key; ?>"><i class="fa-solid fa-user-pen"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif;  ?>
